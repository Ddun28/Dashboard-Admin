...
import { ListContactProps } from "./ListoContact.type";
...
export default async function ListContact(props: ListContactProps) {
  ...
  return (
    <div>
      <div className="mt-4 mb-2 grid grid-cols-3 p-2 items-center justify-between px-4 bg-slate-400/20 rounded-lg">
        <p>Name</p>
        <p>Role</p>
        ...
        <div key={contact.id}>
            <div className="grid grid-cols-3 gap-x-3 items-center justify-between px-4">
                ...
                <div className="flex items-center gap-x-6 justify-end">
                    <a href={`tel:${contact.phone}`} target="_blank"><Phone className="w-4 h-4"/></a>
